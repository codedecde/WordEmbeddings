...
if __name__ == "__main__":
    ...
    embedding_save_file = data_dir + "Models/word2vec_window_{}_negsamples_{}.npy".format(args.window, args.neg_samples)
    w2v.save_embeddings(embedding_save_file)
    # Save the model (so that can be used for training again)
    model_save_file = data_dir + "Models/word2vec_window_{}_negsamples_{}_model.pth".format(args.window, args.neg_samples)
